    ...
    def Retrieve(self,Message,TypeList,FileTransferSocket,MarkerPosition=0):
        ...
        with open(Filename, 'wb') as File:
            ...
            if self.ModeList[0] == True:
                ...
                IncommingData = self.CatchAllData(FileTransferSocket)
        ...
        return str(Reply), str(len(IncommingData)/1000), str(ElapsedTime)
